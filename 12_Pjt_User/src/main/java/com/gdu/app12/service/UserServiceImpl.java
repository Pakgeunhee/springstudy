...
public class UserServiceImpl implements UserService {
	...
	public Map<String, Object> verifyEmail(String email) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("enableEmail", userMapper.selectLeaveUserByEmail(email) == null && userMapper.selectSleepUserByEmail(email) == null && userMapper.selectUserByEmail(email) == null);
		return map;
	}
	...
	public void login(HttpServletRequest request, HttpServletResponse response) {
		...
		// 요청 파라미터
		String url = request.getParameter("url");	// 로그인 화면의 이전 주소(로그인 후 되돌아갈 수 있다.)
		String id = request.getParameter("id");
		String pw = request.getParameter("pw");

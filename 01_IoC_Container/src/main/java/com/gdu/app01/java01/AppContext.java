...
public class AppContext {
	...
	*/
	...
	public Contact contact1() {		// <bean id="contact1" class="Contact">
		...
		c.setTel("02-2222-2220");   // setter <property name="tel" value="02-222-2220"/>
		c.setFax("02-2222-2229");	// setter <property name="fax" value="02-222-2229"/>
	...
	public Contact www() {  // name 속성이 사용되었으므로 메소드명은 더 이상 Bean의 id가 아니에요. 아무 이름이나 써도 됩니다.
		return new Contact("02-3333-3333", "02-3333-3334");
	}
